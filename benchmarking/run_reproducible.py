...
if __name__ == "__main__":
    ...
    plt.title("Reproducible Benchmark: Vision OGR Stability", fontsize=14)
    plt.ylabel("Vision OGR (Overfitting/Generalization)")
    plt.xlabel("Epochs")
    plt.axhline(1.0, color='black', linestyle='--', alpha=0.5)
    plt.ylim(0.8, 3.0)
    plt.tight_layout()
    plt.savefig('benchmark_ogr_repro.png')
    print("Generated benchmark_ogr_repro.png")
