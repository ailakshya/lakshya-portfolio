...
\begin{frame}{}
    \frametitle<presentation>{Literature Review (2023-2024)}
\tiny{
\begin{table}
    \caption{Summary of State-of-the-Art Unified Multimodal Models}	
    \label{tab:litreview-multimodal} 
...
\begin{frame}[allowframebreaks]
    ...
    \begin{thebibliography}{99}
        ...
        \bibitem{missingmodality} Wu, R., et al. "Deep Multimodal Learning with Missing Modality: A Survey." \textit{arXiv}, 2024.
    \end{thebibliography}
\end{frame}
